...
@synthesize super_width,offset_x;
@synthesize withShadow;
...
- (id) initWithString:(NSString *)badgeString withStringColor:(UIColor*)stringColor withInsetColor:(UIColor*)insetColor withBadgeFrame:(BOOL)badgeFrameYesNo withBadgeFrameColor:(UIColor*)frameColor withScale:(CGFloat)scale withShining:(BOOL)shining withShadow:(BOOL)withShadow_ direction:(DirectionType)dir {
...
- (void) autoBadgeSizeWithString:(NSString *)badgeString
{
	...
	if ([badgeString length]>=2) {
		...
		rectWidth = 17 + (stringSize.width + flexSpace); 
        rectHeight = 25;
    ...
    if (direction==FromRight) {
        ...
        self.frame = CGRectMake(-(retValue.width-12.5), self.frame.origin.y, retValue.width, retValue.height);
    }else if(direction==FromRightToLeft){
        
        self.frame = CGRectMake(super_width-retValue.width+offset_x, self.frame.origin.y, retValue.width, retValue.height);
    }
	self.badgeText = badgeString;
...
- (void)autoBadgeSizeWithString:(NSString *)badgeString badgeTextColor:(UIColor *)badgeTextColor_ badgeFrameColor:(UIColor *)badgeFrameColor_  badgeInsetColor:(UIColor *)badgeInsetColor_ frameFixed:(BOOL)frameFixed {

    self.badgeTextColor = badgeTextColor_;
    self.badgeFrameColor = badgeFrameColor_;
    self.badgeInsetColor = badgeInsetColor_;
...
{
	return [[self alloc] initWithString:badgeString withScale:1.0 withShining:YES direction:dir];
}
...
{
	return [[self alloc] initWithString:badgeString withStringColor:stringColor withInsetColor:insetColor withBadgeFrame:badgeFrameYesNo withBadgeFrameColor:frameColor withScale:scale withShining:shining direction:dir];
}
...
+ (CustomBadge*) customBadgeWithString:(NSString *)badgeString withStringColor:(UIColor*)stringColor withInsetColor:(UIColor*)insetColor withBadgeFrame:(BOOL)badgeFrameYesNo withBadgeFrameColor:(UIColor*)frameColor withScale:(CGFloat)scale withShining:(BOOL)shining withShadow:(BOOL)withShadow direction:(DirectionType)dir {
    return [[self alloc] initWithString:badgeString withStringColor:stringColor withInsetColor:insetColor withBadgeFrame:badgeFrameYesNo withBadgeFrameColor:frameColor withScale:scale withShining:shining withShadow:withShadow direction:dir];
}
