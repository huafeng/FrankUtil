...
- (void)setup {
    ...
    // Captions
    self.promptImageView = [[UIImageView alloc] initWithFrame:(CGRect){{0.0f, 0.0f}, {self.maxLblWidth, 0.0f}}];
    self.promptImageView.backgroundColor = [UIColor clearColor];
    self.promptImageView.alpha = 0.0f;
...
- (void)goToCoachMarkIndexed:(NSUInteger)index {
    ...
    CGRect promptRect = [[markDef objectForKey:@"promptRect"] CGRectValue];
    CGRect markRect = [[markDef objectForKey:@"rect"] CGRectValue];
    UIImage *promptImage = [markDef objectForKey:@"promptImage"];
    ...
    self.promptImageView.alpha = 0.0f;
    self.promptImageView.frame = promptRect;
    self.promptImageView.image = promptImage;
    [UIView animateWithDuration:0.3f animations:^{
        self.promptImageView.alpha = 1.0f;
    }];
